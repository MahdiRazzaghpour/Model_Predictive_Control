...
Q = np.diag([100, 100, 10, 3]) # state cost matrix  x = [x, y, v, yaw]
...
# ==============================================================================
raw_data = loadmat('trajectory1D.mat')
cx = raw_data['X_final']
# cx=cx[0:100,:]
cy = raw_data['Y_final']
# cy=cy[0:100,:]
sp = raw_data['Speed_final']
# sp=sp[0:100,:]
cyaw= raw_data['yaw_final']
# cyaw=cyaw[0:100,:]
# ==============================================================================
# -- Classes -------------------------------------------------------------------
# ==============================================================================
...
def main():
    ...
    for i in range(Number_of_vehicels):
        ...
        #print(initial_x)
        vehicle = Agent(i, i*inter_vehicle_time*10 , 0, [cx[-1],cy[-1]] )
